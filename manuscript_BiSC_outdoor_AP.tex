...
Distribution of the concentration for the BiSCAPE and BiSC-Home campaign for all the pollutants were shown in \hyperref[table1]{Table 1}. For all the air pollutants assessed, concentration varied substantially between pollutants. 

%%% Table 1. Outdoor air pollution concentration from BiSC-home and BiSCAPE campaigns (2018-2021) 


%%% --- Table 1. Outdoor air pollution concentration distribution for the BiSC-home and BiSCAPE campaigns --- %%%
\begin{table}[h!]
\centering
\caption{Outdoor air pollution concentration distribution for the BiSC-home and BiSCAPE campaigns}
\begin{tabular}{lllllllll}
\toprule
Campaign & Pollutant & Year & Units & mean & sd & p25 & p50 & p75 \\ 
\midrule
BiSC-home & NO\textsubscript{2} & 2018-2021 & \(\mu\)g/m\textsuperscript{3} & 38.8 & 12.4 & 30.0 & 37.5 & 45.8 \\ 
\multirow{5}{*}{BiSCAPE} 
& PM\textsubscript{25} & 2021-2022 & \(\mu\)g/m\textsuperscript{3} & 13.4 & 6.14 & 9.06 & 11.3 & 16.2 \\ 
& BC & 2021-2022 & \(\mu\)g/m\textsuperscript{3} & 1.27 & 0.50 & 0.88 & 1.22 & 1.52 \\ 
& Fe & 2021-2022 & \(\mu\)g/m\textsuperscript{3} & 0.25 & 0.13 & 0.15 & 0.21 & 0.32 \\ 
& Cu & 2021-2022 & ng/m\textsuperscript{3} & 7.10 & 3.82  & 4.37 & 6.36 & 8.98 \\ 
& Mn & 2021-2022 & ng/m\textsuperscript{3} & 40.7 & 36.5 & 18.9 & 28.2 & 46.7 \\ 
\bottomrule
\end{tabular}
\end{table}

The spatial distribution of the campaigns were showed in \cref{fig1}. 
...
Since different approaches were used to built outdoor air pollution models these were not directly comparable due to differences on temporal 
...
Performance metrics for LUR, DM and HM are shown in the supplementary materials files. 
...
%%% --- Figure x. Boxplot models comparison --- %%%
\captionsetup[figure]{skip=6pt}
% We add the figure with the study domain 
\begin{figure}[!htb]
\includegraphics[width=1.0\textwidth]{figures/boxplot_models.png}
\caption{Distribution exposure concentration for the entire pregnancy period \textit{NO$_2$}, \textit{PM$_{2.5}$}, \textit{BC}.}
\end{figure}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
Correlation for long-term exposure (entire pregnancy) at the residential addresses ranged from r = 0.48 to 0.92 (figure 3.A). 

Correlation for short-term exposure (weekly exposure) varied from r = 0.37 to 0.90 (figure 3.B).   
...
Correlation between the predicted air pollutants for the different models assessed was moderate to strongly correlated for both long-and-short term exposure. 
...
%%%%%%%%%%%%%%%%%%%%%%%%%
\section{Discussion}
We successfully developed spatiotemporal models using three different approaches (LUR, DM and HM). All models show moderate to good performance evaluated by the defined metrics in the \textbf{methods section} and displayed in more detail in the \textbf{Supplementary materials}. 
