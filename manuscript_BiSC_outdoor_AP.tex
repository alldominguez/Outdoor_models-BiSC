...
during developmental periods over the lifespan to traffic-related air pollution (TRAP). Within the framework of the Barcelona Life Study Cohort (BiSC), we developed Land use regression (LUR), dispersion (DM), and hybrid (HM) models to estimate outdoor air pollution exposure at residential addresses for several TRAPs: NO\textsubscript{2}, PM\textsubscript{2.5}, BC, and PM\textsubscript{2.5} constituents (Fe, Cu, Zn). The overall aim is developed and compared LUR, DM, amd HM for predicting outdoor air pollutiuon levels of NO\textsubscript{2}, PM\textsubscript{2.5}, BC, and PM\textsubscript{2.5} consituentes (Fe, Cu, Zn) to obtain accurate weekly estimates of TRAPs, intended to be used in the exposure assessment of BiSC cohort. Two separate monitoring campaigns were conducted. First, the "BiSC-home" measuring home-outdoor NO\textsubscript{2} levels at the home addressess of 984 BiSC participants (2018-2021). Second, the "BiSCAPE" campaign encompassing four distinct measurement of NO\textsubscript{2}, PM\textsubscript{2.5}, and BC in 34 representative points across Barcelona (2021-2022). LUR and DM were constructed using conventional state-of-the-art techniques, while HM was designed by harnessing Random Forest (RF) algorithm, integrating outputs from DM with explanatory variables from the LUR model, monitoring stations and detailed traffic counts. Model performance was evaluated using a cross-validation (CV) and Leave-one-out cross-validation (LOOCV) procedure for LUR and HM, and by comparing the yielded results from the ADM-Urban model with the real values measured by the air quality stations. Additionally, NO\textsubscript{2} models from LUR, DM, and HM, were externally validated using BiSC-home monitoring campaign. The models demonstrated moderate to good performance for LUR, DM and HM. HM outperformed LUR and DM models for NO\textsubscript{2} (R\textsuperscript{2} = 0.64), PM\textsubscript{2.5} (R\textsuperscript{2} = 0.66), and BC (R\textsuperscript{2} = 0.86). LUR models show better performance for PM\textsubscript{2.5 - Fe} (R\textsuperscript{2} = 0.89), PM\textsubscript{2.5 - Cu} (R\textsuperscript{2} = 0.87), PM\textsubscript{2.5 - Zn} (R\textsuperscript{2} = 0.85). Correlations between outdoor air pollution estimates for the different models were moderate to strong for both long-and-short term exposures. Long-term exposure (entire pregnancy) at the residential addresses exhibited correlations ranging from rs = 0.48 to 0.92, while for short-term exposure (weekly exposure) varied from rs = 0.37 to 0.90. Our work emphasizes the importance of employing diverse exposure assessment methods to evaluate the exposure to traffic-related air pollutants and to disentangle differences in effect estimates during pregnancy. The exposure estimates from these different models can be used in the BiSC cohort to potentially identify critical windows of susceptibility to air pollution.\\
...
to estimate BC and metal components across the metropolitan area of Pittsburgh, USA \cite{tripathy2019}. Predictor variables used for the development of LUR and HM models were mainly traffic, residential, and population density-related. We attribute the performance of both the LUR and HM models to their ability to capture the traffic-related processes affecting BC levels throughout the city of Barcelona. This alignment suggest that BC concentrations proportionally reflect traffic-related emissions, underscoring the critical role of traffic sources in urban air pollution in the city of Barcelona.\\ 
