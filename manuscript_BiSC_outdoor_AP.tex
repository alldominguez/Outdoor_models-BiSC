...
% We add the figure with the study domain 
\begin{figure}
\includegraphics[width=0.8\textwidth]{figures/combined_figure1_v2.png}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\newpage
\subsection{Comparison of LUR, DM and HM at address level} % broad title then change this
...
The overall estimated concentration for NO\textsubscript{2} was higher in the HM (36.7 \(\mu\)g/m\textsuperscript{3}) in comparison to LUR (36.4 \(\mu\)g/m\textsuperscript{3}) and DM (27.5 \(\mu\)g/m\textsuperscript{3}). PM\textsubscript{2.5} median concentration was higher for LUR (16.7 \mu\)g/m\textsuperscript{3}) compared to hM (12.2\mu\)g/m\textsuperscript{3}) and DM (11.8\mu\)g/m\textsuperscript{3}). 
