...
The performance of the models varied substantially across different pollutants as shown in \Cref{fig3}. All models exhibit relatively good performance, evaluated by the following metrics; $R^{2}_{\text{10-CV}}$, $RMSE_{\text{10-CV}}$, $R^{2}_{\text{LOOCV}}$, and $RMSE_{\text{LOOCV}}$. The HM performance for NO\textsubscript{2} ($R^{2}_{\text{10-CV}} = 0.64$), PM\textsubscript{2.5} ($R^{2}_{\text{10-CV}} = 0.66$), and BC ($R^{2}_{\text{10-CV}} = 0.86$) was moderate to good, with corresponding $RMSE_{\text{10-CV}}$ values of $7.48 \, \mu\text{g/m}^{3}$, $3.45 \, \mu\text{g/m}^{3}$, and $0.23 \, \mu\text{g/m}^{3}$ while for PM\textsubscript{2.5} componentes, the performance was more conservative with PM\textsubscript{2.5 - Fe} ($R^{2}_{\text{10-CV}} = 0.89$), PM\textsubscript{2.5 - Cu} ($R^{2}_{\text{10-CV}} = 0.87$), and PM\textsubscript{2.5 - Zn} ($R^{2}_{\text{10-CV}} = 0.85$). Conversely, LUR models showed better performance in predicting PM\textsubscript{2.5 - Fe} ($R^{2}_{\text{LOOCV}} = 0.89$), PM\textsubscript{2.5 - Cu} ($R^{2}_{\text{LOOCV}} = 0.87$), and PM\textsubscript{2.5 - Zn} ($R^{2}_{\text{LOOCV}} = 0.85$) concentration levels in comparison to  NO\textsubscript{2} ($R^{2}_{\text{LOOCV}} = 0.62$), PM\textsubscript{2.5} ($R^{2}_{\text{LOOCV}} = 0.45$), and BC ($R^{2}_{\text{LOOCV}} = 0.83$). 
...
\textbf{\Cref{fig3}} presents the distribution of the observed and estimated NO\textsubscript{2}, PM\textsubscript{2.5}, BC,  PM\textsubscript{2.5 - Fe}, PM\textsubscript{2.5 - Cu}, and PM\textsubscript{2.5 - Zn} concentrations from the LUR, DM, and HM. The data shown are long-term estimated concentrations of pollutants during the entire pregnancy period, after averaging weekly estimates for all the study period (2019 - 2021).   
\newpage
